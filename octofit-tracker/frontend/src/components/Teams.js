  ...
  const fetchTeams = () => {
    ...
    fetch(endpoint)
      ...
      .then((data) => {
        ...
        setTeams(Array.isArray(items) ? items : [items]);
      })
      .catch((fetchError) => {
      ...
      <div className="card card-custom shadow-sm">
        <div className="card-header card-header-custom d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
          <div>
            ...
            <p className="mb-0 text-white-50">Browse team records with search, refresh, and endpoint details.</p>
          </div>
          <div className="d-flex gap-2">
            <button className="btn btn-light" type="button" onClick={fetchTeams}>
              Refresh
            </button>
        ...
        <div className="card-body">
          ...
          <div className="row gy-3 mb-3">
            <div className="col-md-8">
              <label className="form-label" htmlFor="teamsSearch">
                Search teams
              </label>
            ...
            <div className="col-md-4 text-md-end align-self-end">
              <span className="badge bg-info text-dark">{filteredTeams.length} teams</span>
            </div>
          </div>
              ...
              <tbody>
                {loading ? (
                  ...
                  filteredTeams.map((team, index) => (
                    <tr key={team.id || team._id || team.name || index}>
                      <td>{index + 1}</td>
          ...
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <p>Endpoint:</p>
                <pre>{endpoint}</pre>
                <p>Total loaded teams: {filteredTeams.length}</p>
              </div>
